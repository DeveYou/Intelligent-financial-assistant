...
import 'package:intelligent_financial_assistant_frontend/common/basewidgets/custom_button.dart';
  ...
  Widget build(BuildContext context) {
    return Container(padding: const EdgeInsets.only(bottom: 40, top: 15),
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(padding:  EdgeInsets.only(top: Dimensions.paddingSizeSmall, bottom: Dimensions.paddingSizeLarge),
